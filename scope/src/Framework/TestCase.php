...
use _PhpScoper5bf3cbdac76b4\Prophecy;
...
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Factory as ComparatorFactory;
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\Diff\Differ;
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\Exporter\Exporter;
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Blacklist;
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Restorer;
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot;
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\ObjectEnumerator\Enumerator;
...
abstract class TestCase extends \PHPUnit\Framework\Assert implements \PHPUnit\Framework\Test, \PHPUnit\Framework\SelfDescribing
{
    ...
    public function run(\PHPUnit\Framework\TestResult $result = null) : \PHPUnit\Framework\TestResult
    {
        ...
        if (($this->runTestInSeparateProcess === \true || $this->runClassInSeparateProcess === \true) && $this->inIsolation !== \true && !$this instanceof \PHPUnit\Runner\PhptTestCase) {
            $class = new \ReflectionClass($this);
            if ($runEntireClass) {
                $template = new \_PhpScoper5bf3cbdac76b4\Text_Template(__DIR__ . '/../Util/PHP/Template/TestCaseClass.tpl');
            } else {
                $template = new \_PhpScoper5bf3cbdac76b4\Text_Template(__DIR__ . '/../Util/PHP/Template/TestCaseMethod.tpl');
            }
    ...
    public function runBare() : void
    {
        ...
        if (isset($e)) {
            if ($e instanceof \_PhpScoper5bf3cbdac76b4\Prophecy\Exception\Prediction\PredictionException) {
    ...
    public function registerComparator(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Comparator $comparator) : void
    {
        \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Factory::getInstance()->register($comparator);
    ...
    {
        if ($this->name === null) {
            throw new \PHPUnit\Framework\Exception('PHPUnit\\Framework\\TestCase::$name must not be null.');
        }
     ...
     */
    protected function prophesize($classOrInterface = null) : \_PhpScoper5bf3cbdac76b4\Prophecy\Prophecy\ObjectProphecy
    {
        ...
        if (!empty($this->dependencies) && !$this->inIsolation) {
            ...
            foreach ($this->dependencies as $dependency) {
                ...
                if (isset($passed[$dependency])) {
                    ...
                    if ($deepClone) {
                        $deepCopy = new \_PhpScoper5bf3cbdac76b4\DeepCopy\DeepCopy();
    ...
    {
        if (!$this->snapshot instanceof \_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot) {
            return;
        }
        ...
        $restorer = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Restorer();
    ...
    private function createGlobalStateSnapshot(bool $backupGlobals) : \_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot
    {
        $blacklist = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Blacklist();
        foreach ($this->backupGlobalsBlacklist as $globalVariable) {
            $blacklist->addGlobalVariable($globalVariable);
        }
        if (!\defined('PHPUNIT_TESTSUITE')) {
            $blacklist->addClassNamePrefix('PHPUnit');
            $blacklist->addClassNamePrefix('_PhpScoper5bf3cbdac76b4\\SebastianBergmann\\CodeCoverage');
            $blacklist->addClassNamePrefix('_PhpScoper5bf3cbdac76b4\\SebastianBergmann\\FileIterator');
            $blacklist->addClassNamePrefix('_PhpScoper5bf3cbdac76b4\\SebastianBergmann\\Invoker');
            $blacklist->addClassNamePrefix('_PhpScoper5bf3cbdac76b4\\SebastianBergmann\\Timer');
            $blacklist->addClassNamePrefix('PHP_Token');
            $blacklist->addClassNamePrefix('Symfony');
            $blacklist->addClassNamePrefix('Text_Template');
            $blacklist->addClassNamePrefix('_PhpScoper5bf3cbdac76b4\\Doctrine\\Instantiator');
        ...
        return new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot($blacklist, $backupGlobals, (bool) $this->backupStaticAttributes, \false, \false, \false, \false, \false, \false, \false);
    }
    /**
     * @throws RiskyTestError
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     * @throws \InvalidArgumentException
     */
    private function compareGlobalStateSnapshots(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot $before, \_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot $after) : void
    {
    ...
    {
        if ($before != $after) {
            $differ = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Diff\Differ($header);
            $exporter = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Exporter\Exporter();
            $diff = $differ->diff($exporter->export($before), $exporter->export($after));
            throw new \PHPUnit\Framework\RiskyTestError($diff);
        }
    }
    private function getProphet() : \_PhpScoper5bf3cbdac76b4\Prophecy\Prophet
    {
        if ($this->prophet === null) {
            $this->prophet = new \_PhpScoper5bf3cbdac76b4\Prophecy\Prophet();
        }
        return $this->prophet;
    }
    /**
    ...
    {
        $enumerator = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\ObjectEnumerator\Enumerator();
    ...
    {
        $factory = \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Factory::getInstance();
