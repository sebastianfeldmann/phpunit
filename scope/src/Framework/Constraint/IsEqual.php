...
class IsEqual extends \PHPUnit\Framework\Constraint\Constraint
{
    ...
    public function evaluate($other, $description = '', $returnResult = \false)
    {
        ...
        $comparatorFactory = \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Factory::getInstance();
        try {
        ...
        } catch (\_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\ComparisonFailure $f) {
            if ($returnResult) {
                return \false;
            }
