...
class Matcher implements \PHPUnit\Framework\MockObject\Matcher\Invocation
{
    ...
    {
        return $this->invocationMatcher !== null && !$this->invocationMatcher instanceof \PHPUnit\Framework\MockObject\Matcher\AnyInvokedCount;
    }
    ...
    public function invoked(\PHPUnit\Framework\MockObject\Invocation $invocation)
    {
        if ($this->invocationMatcher === null) {
            throw new \PHPUnit\Framework\MockObject\RuntimeException('No invocation matcher is set');
        }
        if ($this->methodNameMatcher === null) {
            throw new \PHPUnit\Framework\MockObject\RuntimeException('No method matcher is set');
        }
    ...
    public function verify() : void
    {
        ...
        try {
            ...
            if ($this->parametersMatcher === null) {
                $this->parametersMatcher = new \PHPUnit\Framework\MockObject\Matcher\AnyParameters();
            }
            $invocationIsAny = $this->invocationMatcher instanceof \PHPUnit\Framework\MockObject\Matcher\AnyInvokedCount;
            $invocationIsNever = $this->invocationMatcher instanceof \PHPUnit\Framework\MockObject\Matcher\InvokedCount && $this->invocationMatcher->isNever();
            if (!$invocationIsAny && !$invocationIsNever) {
                $this->parametersMatcher->verify();
            }
        } catch (\PHPUnit\Framework\ExpectationFailedException $e) {
            throw new \PHPUnit\Framework\ExpectationFailedException(\sprintf("Expectation failed for %s when %s.\n%s", $this->methodNameMatcher->toString(), $this->invocationMatcher->toString(), \PHPUnit\Framework\TestFailure::exceptionToString($e)));
        }
    }
