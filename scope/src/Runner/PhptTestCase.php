...
class PhptTestCase implements \PHPUnit\Framework\Test, \PHPUnit\Framework\SelfDescribing
{
    ...
    private function parse() : array
    {
        ...
        foreach ($unsupportedSections as $section) {
            if (isset($sections[$section])) {
                throw new \PHPUnit\Runner\Exception('PHPUnit does not support this PHPT file');
            }
        }
        return $sections;
    }
    ...
    private function renderForCoverage(string &$job) : void
    {
        ...
        $template = new \_PhpScoper5bf3cbdac76b4\Text_Template(__DIR__ . '/../Util/PHP/Template/PhptTestCase.tpl');
        $composerAutoload = '\'\'';
