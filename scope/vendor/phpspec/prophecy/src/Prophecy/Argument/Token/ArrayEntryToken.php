 ...
 */
class ArrayEntryToken implements \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\TokenInterface
{
    ...
    {
        return $value instanceof \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\TokenInterface ? $value : new \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\ExactValueToken($value);
    }
    /**
    ...
    {
        if (!$this->key instanceof \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\ExactValueToken) {
            throw new \_PhpScoper5bf3cbdac76b4\Prophecy\Exception\InvalidArgumentException(\sprintf('You can only use exact value tokens to match key of ArrayAccess object' . \PHP_EOL . 'But you used `%s`.', $this->key));
        }
