 ...
 */
class ArrayEveryEntryToken implements \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\TokenInterface
{
    /**
     * @var TokenInterface
     */
    ...
    {
        if (!$value instanceof \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\TokenInterface) {
            $value = new \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\ExactValueToken($value);
        }
        $this->value = $value;
    }
    /**
