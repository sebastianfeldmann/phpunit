 ...
 */
class ExactValueToken implements \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\TokenInterface
{
    private $value;
    private $string;
    private $util;
     ...
     */
    public function __construct($value, \_PhpScoper5bf3cbdac76b4\Prophecy\Util\StringUtil $util = null, \_PhpScoper5bf3cbdac76b4\Prophecy\Comparator\Factory $comparatorFactory = null)
    {
        $this->value = $value;
