 ...
 */
class LogicalAndToken implements \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\TokenInterface
{
    ...
    public function __construct(array $arguments)
    {
        foreach ($arguments as $argument) {
            if (!$argument instanceof \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\TokenInterface) {
                $argument = new \_PhpScoper5bf3cbdac76b4\Prophecy\Argument\Token\ExactValueToken($argument);
            }
