...
class Call
{
     ...
     * @return $this
     */
    public function addScore(\_PhpScoper5bf3cbdac76b4\Prophecy\Argument\ArgumentsWildcard $wildcard, $score)
    {
     ...
     */
    public function getScore(\_PhpScoper5bf3cbdac76b4\Prophecy\Argument\ArgumentsWildcard $wildcard)
    {
