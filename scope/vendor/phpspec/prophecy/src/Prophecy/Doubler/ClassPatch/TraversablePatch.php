 ...
 */
class TraversablePatch implements \_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\ClassPatch\ClassPatchInterface
{
    /**
    ...
    public function apply(\_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\ClassNode $node)
    {
        ...
        $node->addMethod(new \_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode('current'));
        $node->addMethod(new \_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode('key'));
        $node->addMethod(new \_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode('next'));
        $node->addMethod(new \_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode('rewind'));
        $node->addMethod(new \_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode('valid'));
    }
    /**
