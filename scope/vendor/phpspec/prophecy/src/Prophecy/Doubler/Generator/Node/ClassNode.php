...
use _PhpScoper5bf3cbdac76b4\Prophecy\Exception\Doubler\MethodNotExtendableException;
...
class ClassNode
{
    ...
    public function addProperty($name, $visibility = 'public')
    {
        ...
        if (!\in_array($visibility, array('public', 'private', 'protected'))) {
            throw new \_PhpScoper5bf3cbdac76b4\Prophecy\Exception\InvalidArgumentException(\sprintf('`%s` property visibility is not supported.', $visibility));
        }
    ...
    public function addMethod(\_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode $method, $force = \false)
    {
        if (!$this->isExtendable($method->getName())) {
            $message = \sprintf('Method `%s` is not extendable, so can not be added.', $method->getName());
            throw new \_PhpScoper5bf3cbdac76b4\Prophecy\Exception\Doubler\MethodNotExtendableException($message, $this->getParentClass(), $method->getName());
        }
