...
class ClassCodeGenerator
{
    ...
    public function __construct(\_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\TypeHintReference $typeHintReference = null)
    {
     ...
     * @return string
     */
    public function generate($classname, \_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\ClassNode $class)
    {
    ...
    private function generateMethod(\_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode $method)
    {
     ...
     * @return string
     */
    private function getReturnType(\_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\MethodNode $method)
    {
    ...
    private function generateArguments(array $arguments)
    {
        ...
        return \array_map(function (\_PhpScoper5bf3cbdac76b4\Prophecy\Doubler\Generator\Node\ArgumentNode $argument) use($typeHintReference) {
            $php = '';
            if (\version_compare(\PHP_VERSION, '7.1', '>=')) {
