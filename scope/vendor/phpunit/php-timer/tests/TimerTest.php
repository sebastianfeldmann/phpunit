 ...
 */
namespace _PhpScoper5bf3cbdac76b4\SebastianBergmann\Timer;
...
class TimerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInternalType('float', \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Timer\Timer::stop());
    }
    /**
    ...
    {
        $this->assertEquals($string, \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Timer\Timer::secondsToTimeString($seconds));
    }
    public function testTimeSinceStartOfRequest() : void
    {
        $this->assertStringMatchesFormat('%f %s', \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Timer\Timer::timeSinceStartOfRequest());
    }
    ...
    public function testTimeSinceStartOfRequest3() : void
    {
        ...
        $this->expectException(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\Timer\RuntimeException::class);
        \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Timer\Timer::timeSinceStartOfRequest();
    }
    public function testResourceUsage() : void
    {
        $this->assertStringMatchesFormat('Time: %s, Memory: %fMB', \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Timer\Timer::resourceUsage());
    }
