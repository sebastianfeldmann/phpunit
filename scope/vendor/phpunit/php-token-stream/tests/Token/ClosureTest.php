...
class PHP_Token_ClosureTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $ts = new \_PhpScoper5bf3cbdac76b4\PHP_Token_Stream(\TEST_FILES_PATH . 'closure.php');
        foreach ($ts as $token) {
...
\class_alias('_PhpScoper5bf3cbdac76b4\\PHP_Token_ClosureTest', 'PHP_Token_ClosureTest', \false);
