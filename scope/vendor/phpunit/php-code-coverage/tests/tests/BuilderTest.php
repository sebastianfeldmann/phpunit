...
class BuilderTest extends \SebastianBergmann\CodeCoverage\TestCase
{
    protected $factory;
    protected function setUp()
    {
        $this->factory = new \SebastianBergmann\CodeCoverage\Node\Builder();
    }
    ...
    public function testBuildDirectoryStructure()
    {
        ...
        $method = new \ReflectionMethod(\SebastianBergmann\CodeCoverage\Node\Builder::class, 'buildDirectoryStructure');
    ...
    {
        $method = new \ReflectionMethod(\SebastianBergmann\CodeCoverage\Node\Builder::class, 'reducePaths');
        $method->setAccessible(\true);
