...
final class File extends \SebastianBergmann\CodeCoverage\Report\Html\Renderer
{
    ...
    {
        $template = new \_PhpScoper5bf3cbdac76b4\Text_Template($this->templatePath . 'file.html', '{{', '}}');
    ...
    {
        $template = new \_PhpScoper5bf3cbdac76b4\Text_Template($this->templatePath . 'file_item.html', '{{', '}}');
        $methodItemTemplate = new \_PhpScoper5bf3cbdac76b4\Text_Template($this->templatePath . 'method_item.html', '{{', '}}');
    ...
    protected function renderTraitOrClassItems(array $items, \_PhpScoper5bf3cbdac76b4\Text_Template $template, \_PhpScoper5bf3cbdac76b4\Text_Template $methodItemTemplate) : string
    {
        $buffer = '';
        if (empty($items)) {
            return $buffer;
    ...
    protected function renderFunctionItems(array $functions, \_PhpScoper5bf3cbdac76b4\Text_Template $template) : string
    {
        if (empty($functions)) {
            return '';
        }
    ...
    protected function renderFunctionOrMethodItem(\_PhpScoper5bf3cbdac76b4\Text_Template $template, array $item, string $indent = '') : string
    {
        $numMethods = 0;
        $numTestedMethods = 0;
        if ($item['executableLines'] > 0) {
