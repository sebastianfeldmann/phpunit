...
final class Directory extends \SebastianBergmann\CodeCoverage\Report\Html\Renderer
{
    ...
    {
        $template = new \_PhpScoper5bf3cbdac76b4\Text_Template($this->templatePath . 'directory.html', '{{', '}}');
    ...
    protected function renderItem(\SebastianBergmann\CodeCoverage\Node\AbstractNode $node, bool $total = \false) : string
    {
        ...
        return $this->renderItemTemplate(new \_PhpScoper5bf3cbdac76b4\Text_Template($this->templatePath . 'directory_item.html', '{{', '}}'), $data);
    }
}
