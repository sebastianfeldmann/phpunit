...
abstract class Renderer
{
    ...
    protected function renderItemTemplate(\_PhpScoper5bf3cbdac76b4\Text_Template $template, array $data) : string
    {
        $numSeparator = '&nbsp;/&nbsp;';
    ...
    protected function setCommonTemplateVariables(\_PhpScoper5bf3cbdac76b4\Text_Template $template, \SebastianBergmann\CodeCoverage\Node\AbstractNode $node) : void
    {
    ...
    protected function getCoverageBar(float $percent) : string
    {
        ...
        $template = new \_PhpScoper5bf3cbdac76b4\Text_Template($this->templatePath . 'coverage_bar.html', '{{', '}}');
