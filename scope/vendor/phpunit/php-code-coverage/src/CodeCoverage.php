...
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\CodeUnitReverseLookup\Wizard;
...
final class CodeCoverage
{
    ...
    public function __construct(\SebastianBergmann\CodeCoverage\Driver\Driver $driver = null, \SebastianBergmann\CodeCoverage\Filter $filter = null)
    {
        ...
        $this->driver = $driver;
        $this->filter = $filter;
        $this->wizard = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\CodeUnitReverseLookup\Wizard();
    }
    /**
    ...
    {
        if ($this->report === null) {
            $builder = new \SebastianBergmann\CodeCoverage\Node\Builder();
    ...
    private function getLinesToBeIgnoredInner(string $fileName) : array
    {
        ...
        if ($this->cacheTokens) {
            $tokens = \_PhpScoper5bf3cbdac76b4\PHP_Token_Stream_CachingFactory::get($fileName);
        } else {
            $tokens = new \_PhpScoper5bf3cbdac76b4\PHP_Token_Stream($fileName);
        }
        ...
        foreach ($tokens->tokens() as $token) {
            switch (\get_class($token)) {
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_COMMENT::class:
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_DOC_COMMENT::class:
                    $_token = \trim($token);
                    ...
                    break;
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_INTERFACE::class:
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_TRAIT::class:
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_CLASS::class:
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_FUNCTION::class:
                ...
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_NAMESPACE::class:
                    $this->ignoredLines[$fileName][] = $token->getEndLine();
                // Intentional fallthrough
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_DECLARE::class:
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_OPEN_TAG::class:
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_CLOSE_TAG::class:
                case \_PhpScoper5bf3cbdac76b4\PHP_Token_USE::class:
                    $this->ignoredLines[$fileName][] = $token->getLine();
                    break;
            }
            if ($ignore) {
    ...
    {
        $runtime = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Environment\Runtime();
