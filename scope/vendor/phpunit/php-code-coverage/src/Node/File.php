...
final class File extends \SebastianBergmann\CodeCoverage\Node\AbstractNode
{
    ...
    {
        if ($this->cacheTokens) {
            $tokens = \_PhpScoper5bf3cbdac76b4\PHP_Token_Stream_CachingFactory::get($this->getPath());
        } else {
            $tokens = new \_PhpScoper5bf3cbdac76b4\PHP_Token_Stream($this->getPath());
        }
    ...
    private function processClasses(\_PhpScoper5bf3cbdac76b4\PHP_Token_Stream $tokens) : void
    {
    ...
    private function processTraits(\_PhpScoper5bf3cbdac76b4\PHP_Token_Stream $tokens) : void
    {
    ...
    private function processFunctions(\_PhpScoper5bf3cbdac76b4\PHP_Token_Stream $tokens) : void
    {
