...
final class PHPDBG implements \SebastianBergmann\CodeCoverage\Driver\Driver
{
    ...
    public function __construct()
    {
        ...
        if (!\function_exists('_PhpScoper5bf3cbdac76b4\\phpdbg_start_oplog')) {
    ...
    {
        \_PhpScoper5bf3cbdac76b4\phpdbg_start_oplog();
    }
    /**
    ...
    {
        static $fetchedLines = [];
        $dbgData = \_PhpScoper5bf3cbdac76b4\phpdbg_end_oplog();
        if ($fetchedLines == []) {
            $sourceLines = \_PhpScoper5bf3cbdac76b4\phpdbg_get_executable();
        } else {
