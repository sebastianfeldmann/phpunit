 ...
 */
final class Compound implements \_PhpScoper5bf3cbdac76b4\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /** @var Type[] */
    private $types;
    /**
    ...
    public function __construct(array $types)
    {
        foreach ($types as $type) {
            if (!$type instanceof \_PhpScoper5bf3cbdac76b4\phpDocumentor\Reflection\Type) {
