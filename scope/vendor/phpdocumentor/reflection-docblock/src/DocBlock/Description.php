...
use _PhpScoper5bf3cbdac76b4\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter;
...
class Description
{
    ...
    {
        \_PhpScoper5bf3cbdac76b4\Webmozart\Assert\Assert::string($bodyTemplate);
