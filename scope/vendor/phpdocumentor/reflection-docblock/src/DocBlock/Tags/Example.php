 ...
 */
final class Example extends \_PhpScoper5bf3cbdac76b4\phpDocumentor\Reflection\DocBlock\Tags\BaseTag
{
    /**
    ...
    {
        \_PhpScoper5bf3cbdac76b4\Webmozart\Assert\Assert::notEmpty($filePath);
        \_PhpScoper5bf3cbdac76b4\Webmozart\Assert\Assert::integer($startingLine);
        \_PhpScoper5bf3cbdac76b4\Webmozart\Assert\Assert::greaterThanEq($startingLine, 0);
