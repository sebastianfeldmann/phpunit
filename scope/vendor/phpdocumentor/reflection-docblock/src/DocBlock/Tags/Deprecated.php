 ...
 */
final class Deprecated extends \_PhpScoper5bf3cbdac76b4\phpDocumentor\Reflection\DocBlock\Tags\BaseTag implements \_PhpScoper5bf3cbdac76b4\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    ...
    private $version = '';
    public function __construct($version = null, \_PhpScoper5bf3cbdac76b4\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \_PhpScoper5bf3cbdac76b4\Webmozart\Assert\Assert::nullOrStringNotEmpty($version);
    ...
    {
        \_PhpScoper5bf3cbdac76b4\Webmozart\Assert\Assert::nullOrString($body);
        if (empty($body)) {
            return new static();
        }
        $matches = [];
