 ...
 */
namespace _PhpScoper5bf3cbdac76b4\SebastianBergmann\RecursionContext;
...
class ContextTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->context = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\RecursionContext\Context();
    }
    ...
    {
        $this->expectException(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\RecursionContext\Exception::class);
