 ...
 */
final class AbstractChunkOutputBuilderTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }
