 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {
