...
class CodeExporter
{
    public function constants(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot $snapshot) : string
    {
        $result = '';
    ...
    public function globalVariables(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot $snapshot) : string
    {
    ...
    public function iniSettings(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\GlobalState\Snapshot $snapshot) : string
    {
        $result = '';
