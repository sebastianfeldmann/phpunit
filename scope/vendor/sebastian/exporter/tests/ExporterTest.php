 ...
 */
namespace _PhpScoper5bf3cbdac76b4\SebastianBergmann\Exporter;
...
class ExporterTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->exporter = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Exporter\Exporter();
    }
    public function exportProvider()
    {
        ...
        return array(
            ...
            'export boolean true' => array(\true, 'true'),
            ...
            'export multidimentional array' => array(array(array(1, 2, 3), array(3, 4, 5)), <<<EOF
Array &0 (
    0 => Array &1 (
        0 => 1
        1 => 2
...
EOF
            ...
            'export non empty stdclass' => array($obj, <<<EOF
stdClass Object &%x (
    'null' => null
    'boolean' => true
    'integer' => 1
...
EOF
            ...
            'export splObjectStorage' => array($storage, <<<EOF
...
EOF
            ...
            'export stdClass with numeric properties' => array($obj3, <<<EOF
stdClass Object &%x (
    0 => 1
    1 => 2
    2 => 'Test\\r\\n
...
EOF;
    ...
    public function shortenedExportProvider()
    {
        ...
        return array(
            ...
            'shortened export boolean true' => array(\true, 'true'),
    ...
    {
        return array(array(\implode('', \array_map('chr', \range(0x9, 0xd))), 9), array(\implode('', \array_map('chr', \range(0x20, 0x7f))), 96), array(\implode('', \array_map('chr', \range(0x80, 0xff))), 128));
    }
    /**
