...
class Exporter
{
     ...
     * @return string
     */
    public function shortenedRecursiveExport(&$data, \_PhpScoper5bf3cbdac76b4\SebastianBergmann\RecursionContext\Context $context = null)
    {
        $result = [];
        $exporter = new self();
        if (!$context) {
            $context = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\RecursionContext\Context();
        }
        $array = $data;
        $context->add($data);
