...
use _PhpScoper5bf3cbdac76b4\SebastianBergmann\ObjectEnumerator\Fixtures\ExceptionThrower;
...
class EnumeratorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->enumerator = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\ObjectEnumerator\Enumerator();
    }
    ...
    {
        $thrower = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\ObjectEnumerator\Fixtures\ExceptionThrower();
    ...
    {
        $this->expectException(\_PhpScoper5bf3cbdac76b4\SebastianBergmann\ObjectEnumerator\InvalidArgumentException::class);
