 ...
 */
final class ArrayComparatorTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var ArrayComparator
     */
    ...
    {
        $this->comparator = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\ArrayComparator();
    ...
    {
        return [[['a' => 1, 'b' => 2], ['b' => 2, 'a' => 1]], [[1], ['1']], [[3, 2, 1], [2, 3, 1], 0, \true], [[2.3], [2.5], 0.5], [[[2.3]], [[2.5]], 0.5], [[new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Struct(2.3)], [new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Struct(2.5)], 0.5]];
    }
    public function assertEqualsFailsProvider()
    {
        return [[[], [0 => 1]], [[0 => 1], []], [[0 => null], []], [[0 => 1, 1 => 2], [0 => 1, 1 => 3]], [['a', 'b' => [1, 2]], ['a', 'b' => [2, 1]]], [[2.3], [4.2], 0.5], [[[2.3]], [[4.2]], 0.5], [[new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Struct(2.3)], [new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Struct(4.2)], 0.5]];
    }
