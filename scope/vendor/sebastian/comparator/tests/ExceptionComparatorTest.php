 ...
 */
final class ExceptionComparatorTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->comparator = new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\ExceptionComparator();
