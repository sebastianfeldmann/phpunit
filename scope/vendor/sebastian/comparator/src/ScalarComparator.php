 ...
 */
class ScalarComparator extends \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Comparator
{
    /**
    ...
    public function assertEquals($expected, $actual, $delta = 0.0, $canonicalize = \false, $ignoreCase = \false)
    {
        ...
        if ($expectedToCompare !== $actualToCompare && \is_string($expected) && \is_string($actual)) {
            throw new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\ComparisonFailure($expected, $actual, $this->exporter->export($expected), $this->exporter->export($actual), \false, 'Failed asserting that two strings are equal.');
        }
