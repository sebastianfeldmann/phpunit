 ...
 */
class ArrayComparator extends \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\Comparator
{
    /**
    ...
    public function assertEquals($expected, $actual, $delta = 0.0, $canonicalize = \false, $ignoreCase = \false, array &$processed = [])
    {
        ...
        $actualAsString .= ')';
        if (!$equal) {
            throw new \_PhpScoper5bf3cbdac76b4\SebastianBergmann\Comparator\ComparisonFailure($expected, $actual, $expectedAsString, $actualAsString, \false, 'Failed asserting that two arrays are equal.');
        }
    }
