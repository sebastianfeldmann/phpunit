...
class Extension extends \PharIo\Manifest\Type
{
     ...
     * @return bool
     */
    public function isExtensionFor(\PharIo\Manifest\ApplicationName $name)
    {
     ...
     * @return bool
     */
    public function isCompatibleWith(\PharIo\Manifest\ApplicationName $name, \PharIo\Version\Version $version)
    {
