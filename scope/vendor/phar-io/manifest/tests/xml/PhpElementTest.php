...
class PhpElementTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->php = new \PharIo\Manifest\PhpElement($this->dom->documentElement);
    }
    ...
    {
        $this->addExtElement();
        $this->assertInstanceOf(\PharIo\Manifest\ExtElementCollection::class, $this->php->getExtElements());
    }
