...
class RequiresElementTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->requires = new \PharIo\Manifest\RequiresElement($this->dom->documentElement);
    }
    ...
    public function testHasExtElementsReturnsTrueWhenExtensionsAreRequired()
    {
        ...
        $this->assertInstanceOf(\PharIo\Manifest\PhpElement::class, $this->requires->getPHPElement());
    }
}
