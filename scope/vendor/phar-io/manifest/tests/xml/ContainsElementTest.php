...
class ContainsElementTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->contains = new \PharIo\Manifest\ContainsElement($this->domElement);
    }
    ...
    public function testGetExtensionElementReturnsExtensionElement()
    {
        ...
        $this->assertInstanceOf(\PharIo\Manifest\ExtensionElement::class, $this->contains->getExtensionElement());
    }
}
