...
class VersionTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $version = new \PharIo\Version\Version($versionString);
     ...
     */
    public function testIsGreaterThan(\PharIo\Version\Version $versionA, \PharIo\Version\Version $versionB, $expectedResult)
    {
    ...
    {
        return [[new \PharIo\Version\Version('1.0.0'), new \PharIo\Version\Version('1.0.1'), \false], [new \PharIo\Version\Version('1.0.1'), new \PharIo\Version\Version('1.0.0'), \true], [new \PharIo\Version\Version('1.1.0'), new \PharIo\Version\Version('1.0.1'), \true], [new \PharIo\Version\Version('1.1.0'), new \PharIo\Version\Version('2.0.1'), \false], [new \PharIo\Version\Version('1.1.0'), new \PharIo\Version\Version('1.1.0'), \false], [new \PharIo\Version\Version('2.5.8'), new \PharIo\Version\Version('1.6.8'), \true], [new \PharIo\Version\Version('2.5.8'), new \PharIo\Version\Version('2.6.8'), \false], [new \PharIo\Version\Version('2.5.8'), new \PharIo\Version\Version('3.1.2'), \false], [new \PharIo\Version\Version('3.0.0-alpha1'), new \PharIo\Version\Version('3.0.0-alpha2'), \false], [new \PharIo\Version\Version('3.0.0-alpha2'), new \PharIo\Version\Version('3.0.0-alpha1'), \true], [new \PharIo\Version\Version('3.0.0-alpha.1'), new \PharIo\Version\Version('3.0.0'), \false], [new \PharIo\Version\Version('3.0.0'), new \PharIo\Version\Version('3.0.0-alpha.1'), \true]];
    }
    /**
    ...
    {
        $this->expectException(\PharIo\Version\InvalidVersionException::class);
        new \PharIo\Version\Version($versionString);
    }
    /**
     * @return array
     */
