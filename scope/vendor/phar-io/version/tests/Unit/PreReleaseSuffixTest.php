 ...
 */
class PreReleaseSuffixTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $leftSuffix = new \PharIo\Version\PreReleaseSuffix($leftSuffixValue);
        $rightSuffix = new \PharIo\Version\PreReleaseSuffix($rightSuffixValue);
