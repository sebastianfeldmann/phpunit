...
class Version
{
     ...
     * @return bool
     */
    public function isGreaterThan(\PharIo\Version\Version $version)
    {
    ...
    {
        $this->major = new \PharIo\Version\VersionNumber($matches['Major']);
        $this->minor = new \PharIo\Version\VersionNumber($matches['Minor']);
        $this->patch = isset($matches['Patch']) ? new \PharIo\Version\VersionNumber($matches['Patch']) : new \PharIo\Version\VersionNumber(null);
